...
/**
 * 一致性Hash算法
 * 原文：https://www.cnblogs.com/moonandstar08/p/5405991.html
 * 思想：虚拟节点的思想，为每个物理节点（服务器）在圆上分配100～200个点。这样就能抑制分布不均匀。最大限度地减小服务器增减时的缓存重新分布
 * 
 * 负载均衡的算法有很多，包括： 轮循算法(Round Robin)、哈希算法(HASH)、最少连接算法(Least Connection)、响应速度算法(Response Time)、加权法(Weighted )等。其中哈希算法是最为常用的算法
